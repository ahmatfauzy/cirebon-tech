...
export default function LoginForm() {
  ...
  return (
    <>
      <div
        aria-hidden
        className="absolute inset-0 isolate hidden opacity-65 contain-strict lg:block py-10"
      >
      ...
      <div className="relative bg-background flex flex-col items-center justify-center min-h-screen px-10">
        ...
        <div className="bg-card border border-border rounded-2xl shadow-lg p-8 md:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-foreground mb-2">AgroWin</h1>
          ...
          <div className="mb-8">
            <p className="text-center text-foreground text-sm leading-relaxed">
              Kelola pertanian Anda dengan teknologi terdepan. Masuk untuk
              memulai.
            </p>
          </div>
          ...
          {/* <div className="space-y-3 mb-8 mt-5">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-foreground">
                <span className="font-semibold">Pantau Lahan</span> secara
                real-time
              </p>
            </div>
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-foreground">
                <span className="font-semibold">Analisis Data</span> pertanian
                mendalam
              </p>
            </div>
            <div className="flex items-start gap-3">
